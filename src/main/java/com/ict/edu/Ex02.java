...
public class Ex02 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h2> 제목 태그 </h2>");
		out.println("<h3> 제목 태그 </h3>");
		out.println("<h4> 제목 태그 </h4>");
		out.println("<h5> 제목 태그 </h5>");
		out.println("<h6> 제목 태그 </h6>");
		out.println("<h7> 제목 태그 </h7>");
		out.println("<h8> 제목 태그 </h8>");
